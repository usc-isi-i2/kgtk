...
kgtk ${KGTK_FLAGS} \
     ...
     --label-file ${COUNTDIR}/all.node1.entity.counts.${SORTED_KGTK} \
     ...
     --input-file-is-presorted \
     --columns-to-lift node1 \
     --label-file ${COUNTDIR}/all.label.entity.counts.${SORTED_KGTK} \
     --label-file-is-presorted \
     ...
     --input-file-is-presorted \
     --columns-to-lift node1 \
     --label-file ${COUNTDIR}/all.node2.entity.counts.${SORTED_KGTK} \
     --label-file-is-presorted \
     ...
     --label-file-is-presorted \
     --output-file ${COUNTDIR}/all.total.entity.counts.${SORTED_KGTK}
