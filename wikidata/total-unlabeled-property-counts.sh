...
kgtk ${KGTK_FLAGS} \
     ...
     --input-file ${COUNTDIR}/all.node1.property.counts.unlabeled.${SORTED_KGTK} \
     --input-file ${COUNTDIR}/all.label.property.counts.unlabeled.${SORTED_KGTK} \
     --input-file ${COUNTDIR}/all.node2.property.counts.unlabeled.${SORTED_KGTK} \
     / unique $VERBOSE --use-mgzip=$USE_MGZIP \
     --column node1 \
     / lift $VERBOSE --use-mgzip=$USE_MGZIP \
     --input-file-is-presorted \
     --columns-to-lift node1 \
     --label-file ${COUNTDIR}/all.node1.property.counts.unlabeled.${SORTED_KGTK} \
    ...
    / lift $VERBOSE --use-mgzip=$USE_MGZIP \
     --input-file-is-presorted \
     --columns-to-lift node1 \
     --label-file ${COUNTDIR}/all.label.property.counts.unlabeled.${SORTED_KGTK} \
     --label-file-is-presorted \
     ...
     --input-file-is-presorted \
     --columns-to-lift node1 \
     --label-file ${COUNTDIR}/all.node2.property.counts.unlabeled.${SORTED_KGTK} \
     --label-file-is-presorted \
     ...
     --label-file-is-presorted \
     --output-file ${COUNTDIR}/all.total.property.counts.unlabeled.${SORTED_KGTK}
