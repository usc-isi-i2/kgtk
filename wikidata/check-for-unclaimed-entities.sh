...
kgtk ${KGTK_FLAGS} \
     ...
     --output-file ${DATADIR}/all.node1.entity.counts.unclaimed.${SORTED_KGTK} \
     --input-keys node1 \
     --filter-keys node1
...
kgtk ${KGTK_FLAGS} \
     ...
     --filter-file ${DATADIR}/claims.node1.entity.counts.${SORTED_KGTK} \
     --output-file ${DATADIR}/all.label.entity.counts.unclaimed.${SORTED_KGTK} \
     --input-keys node1 \
     --filter-keys node1
...
kgtk ${KGTK_FLAGS} \
     ...
     --filter-file ${DATADIR}/claims.node1.entity.counts.${SORTED_KGTK} \
     --output-file ${DATADIR}/all.node2.entity.counts.unclaimed.${SORTED_KGTK} \
     --input-keys node1 \
     --filter-keys node1
