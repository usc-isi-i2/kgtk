...
kgtk ${KGTK_FLAGS} \
     ...
     --input-file ${DATADIR}/all.node1.property.counts.unclaimed.${SORTED_KGTK} \
     --input-file ${DATADIR}/all.label.property.counts.unclaimed.${SORTED_KGTK} \
     --input-file ${DATADIR}/all.node2.property.counts.unclaimed.${SORTED_KGTK} \
     / unique $VERBOSE --use-mgzip=$USE_MGZIP \
     --column node1 \
     / lift $VERBOSE --use-mgzip=$USE_MGZIP \
     --label-file ${DATADIR}/all.node1.property.counts.unclaimed.${SORTED_KGTK} \
     ...
     / lift $VERBOSE --use-mgzip=$USE_MGZIP \
     --label-file ${DATADIR}/all.label.property.counts.unclaimed.${SORTED_KGTK} \
     --columns-to-lift node1 \
     ...
     --label-file-is-presorted \
     / lift $VERBOSE --use-mgzip=$USE_MGZIP \
     --label-file ${DATADIR}/all.node2.property.counts.unclaimed.${SORTED_KGTK} \
     --columns-to-lift node1 \
