...
kgtk ${KGTK_FLAGS} \
     ...
     -i /data4/rogers/elicit/cache/datasets/wikidata-20200803/data/part.wikoipedia_sitelink.tsv.gz \
     ...
     -o /data4/rogers/elicit/cache/datasets/wikidata-20200803/data/everythingtsv.gz \
