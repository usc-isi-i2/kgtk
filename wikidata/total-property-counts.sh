...
kgtk ${KGTK_FLAGS} \
     ...
     --label-file ${COUNTDIR}/all.node1.property.counts.${SORTED_KGTK} \
     ...
     --input-file-is-presorted \
     --columns-to-lift node1 \
     --label-file ${COUNTDIR}/all.label.property.counts.${SORTED_KGTK} \
     --label-file-is-presorted \
     ...
     --input-file-is-presorted \
     --columns-to-lift node1 \
     --label-file ${COUNTDIR}/all.node2.property.counts.${SORTED_KGTK} \
     --label-file-is-presorted \
     ...
     --label-file-is-presorted \
     --output-file ${COUNTDIR}/all.total.property.counts.${SORTED_KGTK}
