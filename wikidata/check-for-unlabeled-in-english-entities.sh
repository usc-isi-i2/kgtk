...
kgtk ${KGTK_FLAGS} \
     ...
     --filter-file ${COUNTDIR}/labels.en.node1.entity.counts.${SORTED_KGTK} \
     --output-file ${COUNTDIR}/all.node1.entity.counts.unlabeled.en.${SORTED_KGTK} \
     --input-keys node1 \
     --filter-keys node1
...
kgtk ${KGTK_FLAGS} \
     ...
     --filter-file ${COUNTDIR}/labels.en.node1.entity.counts.${SORTED_KGTK} \
     --output-file ${COUNTDIR}/all.label.entity.counts.unlabeled.en.${SORTED_KGTK} \
     --input-keys node1 \
     --filter-keys node1
...
kgtk ${KGTK_FLAGS} \
     ...
     --filter-file ${COUNTDIR}/labels.en.node1.entity.counts.${SORTED_KGTK} \
     --output-file ${COUNTDIR}/all.node2.entity.counts.unlabeled.en.${SORTED_KGTK} \
     --input-keys node1 \
     --filter-keys node1
