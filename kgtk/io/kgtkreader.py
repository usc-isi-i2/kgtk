...
class KgtkReaderOptions():
    ...
    compression_type: typing.Optional[str] = attr.ib(validator=attr.validators.optional(attr.validators.instance_of(str)), default=INPUT_FORMAT_DEFAULT) # TODO: use an Enum
