...
#                           options=['-i', '--input_file', '--embeddings_file']
#                          )   
    parser.add_argument('-i', '--input_file', '--embeddings_file', action='store', dest='embeddings_file', required=True,
                        help='Input file containing the embeddings for which a Faiss index will be created.',
                        metavar="EMBEDDINGS_FILE")
    
    # Related to output
    parser.add_argument('-o', '--output_file', '--index_file_out', action='store', dest='index_file_out', required=True,
    ...
    # OPTIONAL #
    # Related to input file
    parser.add_argument('-ef', '--embeddings_format', action='store', type=str, dest='embeddings_format', required=False,
    ...
    parser.add_argument('-te', '--max_train_examples', action='store', type=int, dest='max_train_examples', required=False,
